...
public class HttpArrivalDataProvider extends AbstractHttpDataProvider {
    ...
    protected URL getURL() throws MalformedURLException {
       String stopNumber = String.valueOf(this.stop.getNumber());
       String urlString = "http://api.translink.ca/rttiapi/v1/stops/" + stopNumber + "/estimates?apikey="+"kjPANEETYNGgKD9r8E2Q";
